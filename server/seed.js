...
const products = [
  {
    ...
    sizes: [{ name: 'Small (10")', price: 6000 }, { name: 'Medium (14")', price: 7500 }, { name: 'Large (18")', price: 9000 }],
  ...
  },
  {
    ...
    sizes: [{ name: 'Medium (14")', price: 8000 }, { name: 'Large (18")', price: 10000 }],
  ...
  },
  {
    ...
    sizes: [{ name: 'One Size (5")', price: 5000 }],
  ...
  },
  {
    ...
    sizes: [{ name: 'Medium (14")', price: 7000 }, { name: 'Large (18")', price: 8500 }],
  ...
  },
  {
    ...
    sizes: [{ name: 'Large (18")', price: 9000 }, { name: 'XL (22")', price: 10000 }],
  ...
  },
  {
    ...
    sizes: [{ name: 'Small Pair (10")', price: 9500 }, { name: 'Medium Pair (14")', price: 10000 }],
...
const seedDB = async () => {
  try {
    ...
    if (!(await User.findOne({ email: 'mikimemory@gmail.com' }))) {
      await User.create({ name: 'Admin', email: 'mikimemory@gmail.com', password: 'mikimemory15', role: 'admin' });
      console.log('👤 Admin created (mikimemory@gmail.com / mikimemory15)');
    }

    ...
    <div className="container-custom py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
        <div className="flex flex-col items-center md:items-start">
          <h4 className="text-sm font-semibold text-brand-dark mb-6 uppercase tracking-wider">Follow Us</h4>
          <div className="flex gap-4">
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-xl bg-baby-pink/20 flex items-center justify-center text-brand-light hover:bg-blue-600 hover:text-white transition-all">
              <FaFacebookF className="w-5 h-5" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-xl bg-baby-pink/20 flex items-center justify-center text-brand-light hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-500 hover:text-white transition-all">
              <FaInstagram className="w-5 h-5" />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-xl bg-baby-pink/20 flex items-center justify-center text-brand-light hover:bg-black hover:text-white transition-all">
              <FaTwitter className="w-5 h-5" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-xl bg-baby-pink/20 flex items-center justify-center text-brand-light hover:bg-blue-700 hover:text-white transition-all">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3">
              <li className="flex items-center justify-center sm:justify-start gap-3 text-sm text-brand-light">
                <HiOutlineMail className="w-4 h-4 text-brand-warm flex-shrink-0" />
                <span>hello@minimovements.com</span>
              </li>
              <li className="flex items-center justify-center sm:justify-start gap-3 text-sm text-brand-light">
                <HiOutlinePhone className="w-4 h-4 text-brand-warm flex-shrink-0" />
                <span>+1 (555) 123-4567</span>
              </li>
              <li className="flex items-start justify-center sm:justify-start gap-3 text-sm text-brand-light">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-baby-pink/20 gap-4 text-center md:text-left">
        ...
        <div className="flex items-center gap-2 order-1 md:order-2 justify-center">
